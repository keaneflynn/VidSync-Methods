...
![**Figure 3** Calibration frame used in the VidSync program to calibrate the two videos to calculate positions in relativve space](VidSyncFrame.png)
...
###*VidSync Use and Behavior Classification*
    ...
    Movement: Any movment throughout the pool not focused on foraging.
