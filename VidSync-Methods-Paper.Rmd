...
##Distance per Time
    ...
    Calculating distance per time is calculated by tracking a specific individual over the course 
...
##Nearest Neighbor Distance
    ...
    Nearest neighbor distance (NND) has historically been used as a metric for understanding inter/intraspecies interactions as well as making observations about general trends regarding animal density in a study region (Clark 1954).
